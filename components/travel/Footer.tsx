      ...
      <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-2">
              <span className="text-2xl font-bold text-foreground tracking-tight">
                FLY <span className="text-primary">FLY</span>
              </span>
            </Link>
            <p className="text-muted-foreground text-sm leading-relaxed">
              Your trusted travel partner for extraordinary adventures around the world. Making dream vacations a reality since 2014.
            </p>
        ...
        <div className="py-6 border-t border-border/50 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} FLY FLY Travel Agency. All rights reserved.
          </p>
